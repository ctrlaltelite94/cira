        ...
        <div>
                                ...
                                <div className='card'>
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            ...
                                            dicta suscipit laborum voluptatum quidem corporis, recusandae,
                                            fugiat officiis iusto nam doloribus nihil non iure illum
                                            perferendis voluptate et consequatur?
                                        </p>
                                    </div>
                                </div>
            ...
            <div className="container my-5">
                <div className="text-center mb-4">
                    ...
                    <p className="text-muted">We are here to assist you during emergencies with these reliable services.</p>
                </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="card text-center h-100">
                            <div className="card-body">
                                ...
                                <p className="card-text">Quick and efficient ambulance services to get you the help you need immediately.</p>
                            </div>
                        </div>
                    </div>
                    {/* Card 2 */}
                    <div className="col-md-4 mb-4">
                        <div className="card text-center h-100">
                            <div className="card-body">
                                ...
                                <p className="card-text">Fast and timely response to Emergency to minimize damage and ensure safety.</p>
                            </div>
                        </div>
                    </div>
                    {/* Card 3 */}
                    <div className="col-md-4 mb-4">
                        <div className="card text-center h-100">
                            <div className="card-body">
                                ...
                                <p className="card-text">Direct connection to the South African Police Service (SAPS) for security and safety.</p>
                            </div>
                        </div>
                    </div>
                </div>
